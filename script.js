document.addEventListener('DOMContentLoaded', function() {
    emailjs.init('QKFRgvCcL8DVQSzbw'); // Ganti dengan public key Anda
    ...
    window.processOrder = function(event) {
        ...
        if (selectedPayment === 'qris') {
            ...
            document.querySelector('#qrisSection .qr-code').innerHTML = '<img src="qris.jpeg" alt="QRIS" style="max-width:200px;">';
        } else {
